...
4. Downloads one licensed image per scene from Pexels/Openverse, with AI-generated visual fallback.
...
- `PEXELS_API_KEY`: optional free Pexels key for stock images. If omitted, the workflow uses Openverse CC0 images and Pollinations AI visual fallback.
